...
/// The raw AML opcodes the parser understands.
///
/// They are part of the crate's public AML substrate: a consumer of ACPI
/// tables can reuse them to decode terms this crate's own parser does not
/// reach.
pub mod opcode {
...
impl<'a> AmlStream<'a> {
    ...
    pub fn read_bytes(&mut self, len: usize) -> Result<Vec<u8>, AmlError> {
